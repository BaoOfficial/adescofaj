...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Designed an interactive Power BI dashboard to visualize hospital performance metrics, patient admissions, revenue insights, and staff efficiency reports for data-driven healthcare management.",
      image: "https://github.com/user-attachments/assets/ec0425a2-87b4-4e9d-9b6f-6193d0033ec3",
      technologies: ["Power BI", "Data Modeling", "DAX", "Data Analysis", "Visualization"],
      github: null,
    ...
    },
    {
      ...
      description:
        "Created a Power BI dashboard for judicial case analytics, offering insights into case distribution, durations, and outcomes across multiple jurisdictions for data transparency and reporting.",
      image: "https://github.com/user-attachments/assets/4a3dd4bf-6f5b-40a9-bb28-766a2d129da3",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayedProjects.map((project, index) => (
            <Card
              key={project.title}
              className="gradient-border bg-background-secondary border-0 overflow-hidden group"
